...
![Hazel](/Resources/Branding/Hazel_Logo_Text_Light_Square.png?raw=true "Hazel Game Engine")
...
Start by cloning the repository with `git clone --recursive https://github.com/TheCherno/Hazel`. <br />
