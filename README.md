...
If the repository was cloned non-recursively previously, change to the Hazel directory and then use `git submodule update --init` to clone the necessary submodules.
