...
namespace Hazel {
  ...
  {
    //mono_set_assemblies_path("Hazelnut/mono/lib");
  ...
  void ScriptEngine::ReloadAssembly(void)
  {
    mono_domain_set(mono_get_root_domain(), false);
  ...
  Scene* ScriptEngine::GetSceneContext(void)
  {
  ...
  void ScriptEngine::OnRuntimeStop(void)
  {
  ...
  std::unordered_map<std::string, Ref<ScriptClass>> ScriptEngine::GetEntityClasses(void)
  {
  ...
  void ScriptEngine::LoadAssemblyClasses(void)
  {
  ...
  MonoImage* ScriptEngine::GetCoreAssemblyImage(void)
  {
  ...
  MonoObject* ScriptClass::Instantiate(void)
  {
  ...
  void ScriptInstance::InvokeOnCreate(void)
  {
    if (m_OnCreateMethod)
